...
export const metadata: Metadata = {
  ...
  other: { "Content-Language": "id" }
};

const BREADCRUMB_SCHEMA_ID = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Morse Code Translator", item: "https://morsecodeworld.org/" },
    { "@type": "ListItem", position: 2, name: "Penerjemah kode Morse", item: "https://morsecodeworld.org/id" }
  ]
};
...
export default function IndonesianHomePage() {
  ...
  return (
    <>
      <TranslatorShell
        locale="id"
        articleSlot={<SeoArticle locale="id" />}
        bottomContent={
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA_ID) }} />
    </>
  );
}
