...
export const metadata: Metadata = {
  ...
  other: { "Content-Language": "tr" }
};

const BREADCRUMB_SCHEMA_TR = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Morse Code Translator", item: "https://morsecodeworld.org/" },
    { "@type": "ListItem", position: 2, name: "Mors kodu çevirici", item: "https://morsecodeworld.org/tr" }
  ]
};
...
export default function TurkishHomePage() {
  ...
  return (
    <>
      <TranslatorShell
        locale="tr"
        articleSlot={<SeoArticle locale="tr" />}
        bottomContent={
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA_TR) }} />
    </>
  );
}
