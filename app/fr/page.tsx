...
const BREADCRUMB_SCHEMA_FR = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Morse Code Translator", item: "https://morsecodeworld.org/" },
    { "@type": "ListItem", position: 2, name: "Traducteur de code Morse", item: "https://morsecodeworld.org/fr" }
  ]
};
...
export default function FrenchHomePage() {
  ...
  return (
    <>
      <TranslatorShell
        locale="fr"
        articleSlot={<SeoArticle locale="fr" />}
        bottomContent={
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA_FR) }} />
    </>
  );
}
