...
const PAGE_DESCRIPTION =
  "モールス信号翻訳機は国際モールス信号（ITU）に基づき、信号とテキストを双方向に即時変換。音声再生、波形表示、速度・音程調整、コピー対応。登録不要の無料ツールで、PC・スマホから初級者やアマチュア無線の学習・練習・通信確認に最適です。";
...
export const metadata: Metadata = {
  ...
  other: { "Content-Language": "ja" }
};

const BREADCRUMB_SCHEMA_JA = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Morse Code Translator", item: "https://morsecodeworld.org/" },
    { "@type": "ListItem", position: 2, name: "モールス信号翻訳機", item: "https://morsecodeworld.org/ja" }
  ]
};
...
export default function JapaneseHomePage() {
  ...
  return (
    <>
      <TranslatorShell
        locale="ja"
        articleSlot={<SeoArticle locale="ja" />}
        bottomContent={
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA_JA) }} />
    </>
  );
}
