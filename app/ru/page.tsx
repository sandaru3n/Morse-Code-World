...
const BREADCRUMB_SCHEMA_RU = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Morse Code Translator", item: "https://morsecodeworld.org/" },
    { "@type": "ListItem", position: 2, name: "переводчик азбуки Морзе", item: "https://morsecodeworld.org/ru" }
  ]
};
...
export default function RussianHomePage() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA_RU) }} />
    </>
  );
}
